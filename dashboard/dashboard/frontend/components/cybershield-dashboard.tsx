...
const ThreatMapGL = dynamic(
  () => import("@/components/threat-map-gl").then((mod) => mod.ThreatMapGL),
  {
    ssr: false,
    loading: () => (
      <div style={{ flex: 1, background: "#f1f5f9", borderRadius: 5, display: "grid", placeItems: "center", color: "#94a3b8", fontSize: 11 }}>
        Loading map…
      </div>
    ),
  }
        ...
        <div className="cs-topbar-left">
          <div className="cs-brand">
            <div className="cs-brand-icon">
              <Shield size={18} fill="#2563eb" color="#2563eb" />
            </div>
            <span className="cs-brand-title">CyberShield</span>
            <span className="cs-brand-divider">|</span>
            <span className="cs-brand-subtitle">Real-Time Security Insights</span>
          </div>
        </div>
