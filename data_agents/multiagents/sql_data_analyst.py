...
from data_agents.templates import BaseAgent
from data_agents.agents import SQLDatabaseAgent, DataVisualizationAgent
...
class SQLDataAnalyst(BaseAgent):
    ...
    async def ainvoke_agent(
        ...
        **kwargs:
        ...
        from data_agents.multiagents import SQLDataAnalyst
        from data_agents.agents import SQLDatabaseAgent, DataVisualizationAgent
