...
from data_agents.templates import (
...
from data_agents.parsers.parsers import PythonOutputParser
from data_agents.utils.regex import (
...
from data_agents.tools.dataframe import get_dataframe_summary
from data_agents.utils.logging import log_ai_function, log_ai_error
from data_agents.utils.plotly import plotly_from_dict
from data_agents.utils.sandbox import run_code_sandboxed_subprocess
from data_agents.utils.messages import get_last_user_message_content
...
class DataVisualizationAgent(BaseAgent):
    ...
    from data_agents.agents import DataVisualizationAgent
    ...
    df = pd.read_csv("https://raw.githubusercontent.com/Aamod007/Vector-X/refs/heads/main/data/churn_data.csv")
...
def make_data_visualization_agent(
    ...
    import pandas as pd
    from langchain_openai import ChatOpenAI
    from data_agents.agents import data_visualization_agent
